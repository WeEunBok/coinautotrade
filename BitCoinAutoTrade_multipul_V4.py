...
while True:
    try:
        ...
        if krw == 0:
            if dnag_jang[42] - dnag_jang[41] >= 0 and dnag_jang[41] - dnag_jang[40] < 0 and macd_signal[42] < 0 and cci_price[42] < -100 and rsi_arr[29] < 35:
                #krw = current_krw / 100
                krw = 10000
        ...
        if krw != 0:
            if rsi_arr[29] >= 60 or macd_signal[42] <= 0 or dnag_jang[42] - dnag_jang[41] <= 0 or cci_price[42] > 100:
